...
class ManualParameterDTO {
  ...
  static ManualParameterDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'measuredAt'), 'Required key "ManualParameterDTO[measuredAt]" is missing from JSON.');
        assert(json[r'measuredAt'] != null, 'Required key "ManualParameterDTO[measuredAt]" has a null value in JSON.');
        return true;
      }());
